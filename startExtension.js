...
(function () {
  ...
  $('body').append('<div id="jsBugHuntingHelperDiv" style="z-index:1000000;position:fixed;bottom:100px;right:100px;background-color:#e9ecef;border:2px solid black; border-radius:5px; padding:20px;font-size:20px;color:black;font-family:\'-apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, Noto Sans, sans-serif\';"></div>')
