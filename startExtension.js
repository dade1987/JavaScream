...
(function () {
  ...
  fuzzerSettings.innerHTML += '<div><button id="openGuiButton" disabled="disabled" type="button" data-bs-toggle="modal" data-bs-target="#guiModal" style="background-color: brown; border-radius: 5px; padding: 20px; font-size: 20px; color: white; width: 100%;">Please Scan</button></div>'
